...
df_confirmed_us.to_csv(r'./cleaned_files/cleaned_confirmed_us.csv', sep=',', index=False, header=True)
...
print(df_death_us)
df_death_us.to_csv(r'./cleaned_files/cleaned_death_us.csv', sep=',', index=False, header=True)
...
df_confirmed_global.to_csv(r'./cleaned_files/cleaned_confirmed_global.csv', sep=',', index=False, header=True)
...
df_death_global.to_csv(r'./cleaned_files/cleaned_death_global.csv', sep=',', index=False, header=True)
...
df_recovered_global.to_csv(r'./cleaned_files/cleaned_recovered_global.csv', sep=',', index=False, header=True)